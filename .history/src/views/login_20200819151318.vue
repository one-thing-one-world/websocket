    ...
    <div class="right">
      ...
      <div class="bottom">
        ...
        <div class="bottom-img">
          ...
          <div class="head-pic" @click="uploadImg"><img src="../assets/file.png" alt=""></div>
        </div>
        <div class="textarea-box">
          <textarea name id cols="90" ref="textname" @change="changeImg" @keyup.shift.ctrl.enter="clickGroup" v-model="textValue" rows="6"></textarea>
        </div>
        <div class="send-box">
