    ...
    <div class="right">
      ...
      <div class="bottom">
        ...
        <div class="bottom-img">
          ...
          <input type="file" class="inputImg"  @change="changeImg">
          
          </div>
        </div>
        <div class="textarea-box">
          <textarea name id cols="90" ref="textname" @keyup.shift.ctrl.enter="clickGroup" v-model="textValue" rows="6"></textarea> 
        </div>
        <div class="send-box">
...
export default {
  ...
  methods: {
    changeImg(){
     let some =  this.$refs.textname.innerHTML
  console.log(some);
    },
    uploadImg(){
