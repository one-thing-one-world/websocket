  ...
  <div v-if="flag" class="box">
    ...
    <div class="right">
          ...
          <div v-for="(item,index) in messageList" :key="index">
            ...
            <div v-else>
              <div v-if="item.username==value" class="item-box">
                <div class="sendvalue" v-html="item.msg"></div>
      ...
      <div class="bottom">
        ...
        <div v-if="pickerFlag" class="emig-box">
          <picker set="emojione" :showSearch="false" :showPreview="false" @select="addEmoji" />
        </div>

        <div class="bottom-img">
          <div class="head-pic" @click="choseEmig"><img src="../assets/head.png" alt=""></div>
          <div class="head-pic"><img src="../assets/pick.png" alt=""></div>
          <div class="head-pic head-pic2" @click="uploadImg"><img src="../assets/file.png" alt="">
            <div class="inputImg">
        ...
        <div class="textarea-box">
          ...
          <div contenteditable="true" class="group" ref="textname" @keyup.shift.ctrl.enter="clickGroup"></div>
  ...
  methods: {
    changeImg(e) {
      ...
      fr.onload = () => {
        ...
        this.$refs.textname.innerHTML = `<img src="${fr.result}" width="100px" height="100px" alt="">`
    ...
    addEmoji(e) {
      this.$refs.textname.innerHTML = e.native
    ...
    sendMessage() {
      console.log(this.$refs.textname.innerHTML);

      this.$socket.emit("sendMessage", {

        msg: this.$refs.textname.innerHTML,
        username: this.value,
        avatar: this.imgValue,

      });
      this.$refs.textname.innerHTML = "";
