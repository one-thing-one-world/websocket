  ...
  <div v-if="flag" class="box">
    ...
    <div class="right">
      ...
      <div class="bottom">
        ...
        <div class="emig-box" >
            <picker :i18n="{ search: 'Recherche', categories: { search: 'Résultats de recherche', recent: 'Récents' } }" :style="{ position: 'absolute', bottom: '20px', right: '20px' }" set="emojione" @select="addEmoji"/>
        </div>

        <div class="bottom-img">
          <div class="head-pic" @click="choseEmig"><img src="../assets/head.png" alt=""></div>
          <div class="head-pic"><img src="../assets/pick.png" alt=""></div>
          <div class="head-pic"><img src="../assets/file.png" alt=""></div>
        </div>
