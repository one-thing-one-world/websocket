...
<div class="container">
  ...
  <div v-if="flag" class="box" v-if="listLeft.length>0">
    <div class="left">
      <div>
        <div class="username">
          <div class="avatar">
            <img :src="listLeft[listLeft.length-1].avatar" alt />
          </div>
          <div class="username-text">{{listLeft[listLeft.length-1].username}}</div>
        </div>
      </div>
