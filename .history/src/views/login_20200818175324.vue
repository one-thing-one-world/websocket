  ...
  <div class="container">
    ...
    <div v-if="flag" class="box">
      ...
      <div class="right">
        ...
        <div class="content b1" v-if="messageList.length>0">
          <div v-for="(item,index) in messageList" :key="index">
            <div v-if="item.username==username" class="item-box">
            ...
            <div v-if="item.username != username" class="box-item">
              <div class="messageImg">
                <img :src="item.avatar" alt />
              </div>
              <div class="sendvalue">{{item.msg}}</div>
            ...
            <div v-if="item.msg===''">
              <div class="userGoOut">{{item.username}}加入群聊</div>
            </div>
          </div>
        </div>
        <div class="bottom">
